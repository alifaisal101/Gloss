...
namespace Gloss.Infrastructure.Migrations
{
    ...
    [Migration("20260619000000_AddIgnoredMergeRequestsTable")]
    partial class AddIgnoredMergeRequestsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gloss.Domain.MergeRequests.IgnoredMergeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ignored_merge_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Gloss.Domain.MergeRequests.IgnoredMergeRequest", b =>
                {
                    b.HasOne("Gloss.Domain.Repositories.Repository", null)
                        ...
                        .HasConstraintName("FK_ignored_merge_requests_repositories_RepositoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
